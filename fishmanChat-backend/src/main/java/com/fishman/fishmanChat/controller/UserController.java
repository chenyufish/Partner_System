package com.fishman.fishmanChat.controller;

import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.fishman.fishmanChat.common.BaseResponse;
import com.fishman.fishmanChat.common.ErrorCode;
import com.fishman.fishmanChat.common.ResultUtils;
import com.fishman.fishmanChat.exception.BusinessException;
import com.fishman.fishmanChat.model.domain.User;
import com.fishman.fishmanChat.model.request.UpdatePasswordRequest;
import com.fishman.fishmanChat.model.request.UserLoginRequest;
...
import com.fishman.fishmanChat.utils.MessageUtils;
import com.fishman.fishmanChat.utils.ValidateCodeUtils;
...
import static com.fishman.fishmanChat.contant.SystemConstants.PAGE_SIZE;
import static com.fishman.fishmanChat.contant.UserConstants.ADMIN_ROLE;
...
//        Integer code = ValidateCodeUtils.generateValidateCode();
    ...
    public BaseResponse<String> sendMailUpdateMessage(String email,
        ...
        mimeMessageHelper.setFrom(new InternetAddress("fishmanChat <" + userFrom + ">"));
        mimeMessageHelper.setTo(email);
        mimeMessageHelper.setSubject("fishmanChat验证码");
